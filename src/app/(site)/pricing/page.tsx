...
import { KeyDifferencesSection } from "@/components/pricing/KeyDifferencesSection";
...
function RequestServiceLink() {
  return (
    <Link
      href="/contact"
      className="mt-6 inline-flex items-center gap-1.5 text-sm font-bold text-lime-500 transition hover:text-green-700"
    >
      Request Service
...
/** Fixed pricing section photos — pricing-1 … pricing-8 */
const sectionImages: Record<string, string> = {
  intro: "/images/pricing-1.png",
  thermal: "/images/pricing-2.png",
  aprehend: "/images/pricing-3.png",
  combination: "/images/pricing-4.png",
  mice: "/images/pricing-5.png",
  cockroach: "/images/pricing-6.png",
  ants: "/images/pricing-7.png",
  wasps: "/images/pricing-8.png",
};

function sectionPhoto(sectionId: string, fallback: string) {
  return sectionImages[sectionId] || resolveCmsImage(fallback);
}
    ...
    <>
      <section className="relative overflow-hidden bg-base-900 pt-32 pb-16 text-white md:pt-40">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center lg:px-8">
          <h1 className="font-display mx-auto max-w-4xl text-[1.75rem] font-extrabold tracking-tight sm:text-4xl md:text-5xl">
            {page.heroTitle}
          </h1>
      ...
      <section className="bg-surface py-14">
        <div className="mx-auto max-w-7xl space-y-10 px-4 lg:px-8">
          {beforeTable.map((section) => (
            ...
            >
              ...
              <div className="relative min-h-56 overflow-hidden rounded-2xl border border-line">
                <Image
                  src={sectionPhoto(section.id, section.image || page.heroImage)}
                  alt={section.title}
                  fill
                  ...
                  {comparisonRows.map((row) => (
                    <tr key={row.treatment} className="hover:bg-band/60">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Link
                          href="/contact"
                          className="inline-flex items-center gap-1 text-sm font-bold text-lime-500 transition hover:text-green-700"
                        >
                          Request Service
          ...
          {afterTable.map((section) =>
            ...
            section.title === "Our Core Warranties" ? (
